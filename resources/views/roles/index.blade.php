...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <div class="page-title-icon">
                <i class="fas fa-user-tag icon-gradient bg-ripe-malin"></i>
            </div>
            <div>Manage Roles
    ...
    <div class="btn-actions-pane-right" style="float: right">
        <a href="{{route('roles.add')}}" class="btn btn-primary btn-sm col-14">+ Add New Product</a>&nbsp;
    </div>
</div>
        ...
        <div class="card-header">Manage Roles
            <div class="btn-actions-pane-right">
                <div role="group" class="btn-group-sm btn-group">
                    ...
                    <a href="{{route('roles.export_format','Csv')}}" class="btn btn-primary">csv</a>&nbsp;
                    <button onclick="downloadPDFWithBrowserPrint()" class="btn btn-primary">Pdf</button>&nbsp;
                    <a href="{{route('roles.export')}}" class="btn btn-primary">Excel</a>&nbsp;
                </div>
            </div>
        </div>
                ...
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr align="center">
                            ...
                            <td>
                                <a class="btn btn-primary" style="width:70px;" href="{{route('roles.edit',$role->id)}}" role="button">Edit</a>
                                <a class="btn btn-primary" style="width:70px;" href="{{route('role.delete',$role->id)}}" role="button">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
