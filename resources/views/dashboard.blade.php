...
{{-- <x-app-layout>
    ...
    <center>
        <a href="{{route('product.create')}}" class="btn btn-primary btn-sm col-1">Add New Product</a>
        <a href="{{route('product.index')}}" class="btn btn-primary btn-sm col-1">Show table</a>
    </center>
...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/dashboards-commerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Dec 2021 01:43:44 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Commerce Dashboard - This dashboard was created as an example of the flexibility that Architect offers.
    </title>
    <meta name="viewport"
...
<body>
                                    ...
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            ...
                                            <img width="42" class="rounded-circle"
                                                src="user_images/{{Auth::user()->image}}" alt="">
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="50" class="rounded-circle"
                                                                        src="user_images/{{Auth::user()->image}}"
                                                                        alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                <a href="{{route('dash')}}" active>
                                    <i class="metismenu-icon fas fa-rocket"></i>Dashboard
                                </a>
                            </li>
                        ...
                        @if(Auth::user()->role_id==1 || Auth::user()->role_id==2)
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fas fa-pager"></i>Products
                        ...
                        @if(Auth::user()->role_id==1)
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fas fa-user-tag"></i>Roles
                                    <i class="metismenu-state-icon fas fa-sort-down"></i>
                                </a>
                                <ul>
                                    <li>
                        ...
                        @if(Auth::user()->role_id==1 || Auth::user()->role_id==2 || Auth::user()->role_id==3)
                            <li class="app-sidebar__heading">Components</li>
                                <li>
                                    <a href="#">
                                        <i class="metismenu-icon fas fa-shopping-cart"></i> Order
                                        <i class="metismenu-state-icon fas fa-sort-down"></i>
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="{{route('orders.index')}}">
                                                <i class="metismenu-icon"></i>Manage Order
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        @if(Auth::user()->role_id==1 || Auth::user()->role_id==2)
                                <a href="#">
                                    <i class="metismenu-icon fas fa-coins"></i> Transactions
                                    <i class="metismenu-state-icon fas fa-sort-down"></i>
                                </a>
                                <ul>
                                    <li>
                        ...
                        @if(Auth::user()->role_id==1 || Auth::user()->role_id==2)
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fas fa-key"></i> Secrets
                                    <i class="metismenu-state-icon fas fa-sort-down"></i>
                                </a>
                                <ul>
                                    <li>
                    ...
                    <div class="app-footer">
                        <div class="app-footer__inner">
                            <div class="app-footer-left">
                                <strong>Copyright &copy; 2021-2022 <a href="{{route('dash')}}">Architect</a>.</strong>
                                All rights reserved.
                            </div>
    ...
    <div class="app-drawer-wrapper" id="demo">
...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/dashboards-commerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Dec 2021 01:43:47 GMT -->
