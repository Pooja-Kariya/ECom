        ...
        <div class="main-agileinfo">
            <div class="agileits-top">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <br>
                        <h5>Mobile No.</h5>
                        <input type="text" name="mobile" id="mobile" :value="old('mobile')" placeholder="Mobile"
                            required autofocus>
                        <br>
                        <h5>Address</h5>
                        ...
                        {{-- <input type="text" name="country_id" id="country_dd" :value="old('country_id')"
                        ...
                        {{-- <input type="text" name="state_id" id="state_dd" :value="old('state_id')"
                        ...
                        <br>
                        <br>
                        {{-- <input type="text" name="city_id" id="city_dd" :value="old('city_id')" placeholder="City"
                            required autofocus> --}}
                            <h5>City</h5>
                        ...
                        <br>
                        <h5>Pincode</h5>
                        <input type="text" name="pincode" id="pincode" :value="old('pincode')" placeholder="pincode"
                            required autofocus>
                        <br>
                        {{-- <input type="text" name="role_id" id="role_id" :value="old('role_id')" placeholder="Role"
                            required autofocus> --}}
                            <h5>Role</h5>
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation"
                            :value="old('password_confirmation')" placeholder=" Confirm password" required autofocus>
                        <br>
                        {{-- <x-button class="ml-4">
                            {{ __('Register') }}
                        </x-button> --}}
